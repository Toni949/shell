...
if($type!='file'){
return ($file=='..'?$s.'back.png':$a.'nqsYd5fs/Download-Folder-3-D-folder-icon-3-D-folder-symbol-3-D-folder-image-for-free-removebg-preview.png');
}else{
$ext = explode('.',$file);
$ext = end($ext);
$ext = strtolower($ext);
